"""
AI_Trading_Journal statanalyser 目錄

【功能說明】
------------------------------------------------------------
本目錄為 AI_Trading_Journal 統計分析核心，包含各類統計檢定、分析與報表產生模組。
...
```mermaid
flowchart TD
    A[main.py/主流程] -->|from core.analytics import ...| B[各分析子模組]
...
【範例】
------------------------------------------------------------
- from core.analytics import CorrelationTest, ReportGenerator
