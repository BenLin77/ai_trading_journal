"""
Base_core.analytics.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 統計分析模組的抽象基底類，統一規範所有統計檢定/分析器（如自相關、相關性、分布、定態性等）的介面與繼承結構，確保分析流程一致、易於擴充。
...
- statanalyser/ReportGenerator_core.analytics.py
- 專案 README
"""
