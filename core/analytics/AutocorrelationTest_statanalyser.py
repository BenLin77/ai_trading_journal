"""
AutocorrelationTest_core.analytics.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 統計分析模組，負責對時序數據進行自相關檢定（如 ACF、PACF、Durbin-Watson、Ljung-Box 等），評估殘差或報酬率的自相關性與週期性，輔助模型選擇與診斷。
...
- Base_core.analytics.py、ReportGenerator_core.analytics.py
- 專案 README
"""
