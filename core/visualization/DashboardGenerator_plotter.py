"""
DashboardGenerator_core.visualization.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 可視化平台的界面生成核心模組，負責生成基於 Dash 的可視化平台界面，包含參數篩選控制面板、權益曲線圖表、績效指標表格等組件。
...
class DashboardGenerator:
    ...
    def create_app(self, data: Dict[str, Any]) -> dash.Dash:
        ...
        try:
            ...
            self.app.title = "AI_Trading_Journal 可視化平台"
        ...
        return html.Div(
            [
                dbc.Navbar(
                    dbc.Container(
                        [
                            dbc.NavbarBrand("AI_Trading_Journal 可視化平台", className="ms-2"),
                            dbc.Nav(
                                [
                                    # 頁面切換按鈕
                                    dbc.NavItem(
                                    ...
                                    dbc.NavItem(
                                        dbc.NavLink(
                                            "AI_Trading_Journal官網",
                                            href="https://AI_Trading_Journal.com",
                                            target="_blank",
                                            style={
                                                "color": "#ecbc4f",
                                                "fontWeight": "bold",
                                    ...
                                    dbc.NavItem(
                                        dbc.NavLink(
                                            "AI_Trading_Journal終身會籍詳情",
                                            href="https://AI_Trading_Journal.com/membership/",
                                            target="_blank",
                                            style={
                                                "color": "#ecbc4f",
                                                "fontWeight": "bold",
                                    ...
                                    dbc.NavItem(
                                        dbc.NavLink(
                                            "其他社群連結",
                                            href="https://linktr.ee/AI_Trading_Journal",
                                            target="_blank",
                                            style={
                                                "color": "#ecbc4f",
                                                "fontWeight": "bold",
    ...
    def _create_parameter_landscape_content(self, data: Dict[str, Any]) -> html.Div:
        ...
        try:
            ...
            return plateau_core.visualization.create_parameter_landscape_layout(data)
