"""
Base_core.visualization.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 可視化平台框架的核心協調器，定義可視化平台的標準介面與主要流程，負責協調數據載入、界面生成、回調處理等各個子模組。
...
class BasePlotter(ABC):
    ...
    def setup_callbacks(self):
        ...
        try:
            ...
            plateau_core.visualization.data_importer = self.data_importer

            plateau_core.visualization.register_callbacks(self.app, self.data)
