"""
AI_Trading_Journal dataloader 目錄

【功能說明】
------------------------------------------------------------
本目錄為 AI_Trading_Journal 數據載入與預處理核心，包含各類行情數據來源、驗證、導出、預測、計算等模組。
...
```mermaid
flowchart TD
    A[main.py/主流程] -->|from core.data_feed import ...| B[各數據載入子模組]
...
【範例】
------------------------------------------------------------
- from core.data_feed import DataLoader, PredictorLoader, DataExporter
