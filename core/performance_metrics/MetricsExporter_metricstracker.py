"""
MetricsExporter_core.performance_metrics.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 績效分析框架的績效指標導出工具，負責將績效分析結果導出為多種格式，支援 CSV、Excel、JSON 等格式，便於後續分析。
...
------------------------------------------------------------
- pandas 官方文件
- Base_core.performance_metrics.py、MetricsCalculator_core.performance_metrics.py
- 專案 README
"""
