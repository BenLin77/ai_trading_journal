"""
MetricsRunner_core.automation.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal Autorunner 的績效分析封裝器，負責在自動化流程中
...
class MetricsRunnerAutorunner:
    ...
    def __init__(self, logger: Optional[logging.Logger] = None):
        self.logger = logger or logging.getLogger("AI_Trading_Journal.core.automation.metrics")
