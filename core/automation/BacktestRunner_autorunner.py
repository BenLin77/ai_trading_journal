#!/usr/bin/env python3
"""
BacktestRunner_core.automation.py
...
class BacktestRunnerAutorunner:
    ...
    def __init__(self, logger: Optional[logging.Logger] = None):
        self.logger = logger or logging.getLogger("AI_Trading_Journal.core.automation.backtest")
    ...
    def run_backtest(
        ...
        try:
            ...
            core.backtest_engine.predictor_column = predictor_column
            
            # 步驟 3: 直接調用 VectorBacktestEngine
            from core.backtest_engine.VectorBacktestEngine_backtester import VectorBacktestEngine
            ...
            # 步驟 4: 設置結果並導出
            core.backtest_engine.results = results
    ...
    def _convert_config(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for param_key, param_config in raw_indicator_params.items():
            ...
            try:
                from core.backtest_engine.Indicators_backtester import IndicatorsBacktester
