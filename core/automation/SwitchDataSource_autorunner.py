#!/usr/bin/env python3
"""
SwitchDataSource_core.automation.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal autorunner 數據源切換工具，提供快速切換配置文件中數據源的功能，
支援 Yahoo Finance、Binance、Coinbase API 和本地文件四種數據源。

【使用方法】
------------------------------------------------------------
python autorunner/SwitchDataSource_core.automation.py yfinance
python autorunner/SwitchDataSource_core.automation.py binance
python autorunner/SwitchDataSource_core.automation.py coinbase
python autorunner/SwitchDataSource_core.automation.py file
...
- 與 DataLoader_core.automation.py 協同工作
"""
