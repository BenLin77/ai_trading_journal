...
class DataLoaderAutorunner:
    ...
    def __init__(self, logger: Optional[logging.Logger] = None):
        ...
        from core.data_feed.file_loader import FileLoader
    ...
    def load_data(self, config: Dict[str, Any]) -> Optional[pd.DataFrame]:
        ...
        try:
            ...
            if source == "yfinance":
                from core.data_feed.yfinance_loader import YahooFinanceLoader
                ...
                from core.data_feed.binance_loader import BinanceLoader
                ...
                from core.data_feed.coinbase_loader import CoinbaseLoader
    ...
    def _calculate_returns(self, config: Dict[str, Any]) -> pd.DataFrame:
        ...
        try:
            from core.data_feed.calculator_loader import ReturnCalculator
    ...
    def _process_difference(self, config: Dict[str, Any]) -> pd.DataFrame:
        ...
        try:
            from core.data_feed.predictor_loader import PredictorLoader
