"""
Base_core.automation.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal Autorunner 的核心控制器，負責協調整個自動化回測流程。
...
- backtester/TradeRecordExporter_core.backtest_engine.py
- main.py
"""
...
from core.automation.BacktestRunner_autorunner import BacktestRunnerAutorunner

# 導入 autorunner 模組
from core.automation.ConfigLoader_autorunner import ConfigLoader
from core.automation.ConfigSelector_autorunner import ConfigSelector
from core.automation.ConfigValidator_autorunner import ConfigValidator
from core.automation.DataLoader_autorunner import DataLoaderAutorunner
from core.automation.MetricsRunner_autorunner import MetricsRunnerAutorunner
...
class BaseAutorunner:
    ...
    def __init__(self, logger: Optional[logging.Logger] = None):
        ...
        self.logger = logger or logging.getLogger("AI_Trading_Journal.autorunner")
        ...
        # 設定基本路徑
        # core/automation/Base_autorunner.py -> core/automation -> core -> project_root
        self.project_root = Path(__file__).parent.parent.parent
        self.configs_dir = self.project_root / "records" / "autorunner"
        self.templates_dir = self.project_root / "core" / "automation" / "templates"
    ...
    def _display_welcome(self) -> None:
        ...
        welcome_content = (
            "[bold #dbac30]🚀 AI_Trading_Journal Autorunner[/bold #dbac30]\n"
    ...
    def _display_backtest_summary(self, backtest_results: Dict[str, Any]) -> None:
        ...
        try:
            ...
            from core.backtest_engine.TradeRecordExporter_backtester import TradeRecordExporter_backtester
