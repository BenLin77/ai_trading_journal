"""
TradeRecorder_core.backtest_engine.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 回測框架的交易記錄工具，負責記錄和管理回測過程中的交易詳情，包括開倉、平倉、持倉變化等資訊。
...
- BacktestEngine_core.backtest_engine.py、TradeRecordExporter_core.backtest_engine.py
- 專案 README
"""
