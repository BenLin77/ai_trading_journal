"""
BollingerBand_Indicator_core.backtest_engine.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 回測框架的布林通道指標工具，負責產生布林通道信號，支援多種突破策略和通道寬度設定。
...
- Indicators_core.backtest_engine.py、BacktestEngine_core.backtest_engine.py、VectorBacktestEngine_core.backtest_engine.py
- 專案 README
"""
