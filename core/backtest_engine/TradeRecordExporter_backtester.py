"""
TradeRecordExporter_core.backtest_engine.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 回測框架的交易記錄導出工具，負責將回測結果和交易記錄導出為多種格式，支援 CSV、Excel、Parquet 等格式，便於後續分析。
- 提供智能回測摘要顯示，包含策略績效統計
...
- Base_core.backtest_engine.py、TradeRecorder_core.backtest_engine.py
- 專案 README
"""
