"""
MovingAverage_Indicator_core.backtest_engine.py

【功能說明】
------------------------------------------------------------
本模組為 AI_Trading_Journal 回測框架的移動平均指標工具，負責產生移動平均線信號，支援單均線、雙均線、多均線等多種策略型態。
...
- Indicators_core.backtest_engine.py、BacktestEngine_core.backtest_engine.py
- 專案 README
"""
