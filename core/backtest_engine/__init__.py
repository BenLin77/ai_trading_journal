"""
AI_Trading_Journal backtester 目錄

【功能說明】
------------------------------------------------------------
本目錄為 AI_Trading_Journal 回測框架核心，包含回測引擎、指標系統、交易模擬、結果導出等模組。
...
```mermaid
flowchart TD
    A[main.py/主流程] -->|from core.backtest_engine import ...| B[各回測子模組]
    B -->|回測結果| C[用戶/下游模組]
```
...
【範例】
------------------------------------------------------------
- from core.backtest_engine import BaseBacktester, BacktestEngine
- from core.backtest_engine import MovingAverageIndicator
